...
export const en: Dict = {
  mainMenu: {
    ...
    serviceMenu: 'Arm an experimental mode (destroys the robot)',
  ...
  serviceMenu: {
    title: 'Service menu',
    warning: 'When a mode runs out, the robot is destroyed. Hold to arm.',
    shield: 'Shield',
    overload: 'Jammer overload',
    shieldNote: 'Total immunity while it lasts — long enough to walk a run through fire.',
    overloadNote: 'On the last beat, an EMP: everything hostile in range shuts down.',
    unavailable: 'This robot has nothing to overload.',
    running: 'A mode is already running.',
    holdToArm: 'Hold',
    seconds: 's',
  },
  formations: {
