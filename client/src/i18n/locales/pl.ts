...
export const pl: Dict = {
  mainMenu: {
    ...
    serviceMenu: 'Uzbrój tryb eksperymentalny (spala kadłub)',
  ...
  serviceMenu: {
    ...
    warning: 'Każdy tryb spala kadłub. Przytrzymaj, aby uzbroić.',
    shield: 'Tarcza',
    ...
    unavailable: 'Ten kadłub nie ma czego przeciążyć.',
