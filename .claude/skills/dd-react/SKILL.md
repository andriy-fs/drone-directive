...
- `screens/` — `MainMenu` (difficulty + a gear button opening `BaseSetupModal`), `BaseSetupModal` (auto-produce + robot program; grows with more base settings), `OnlineLobby`, `GameOverModal`.
