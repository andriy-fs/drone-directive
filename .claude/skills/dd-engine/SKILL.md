...
- `systems/*` — each is `(ctx: GameContext, dt?) => void`, iterating `ctx.world.with(...)`: `commands, economy, ai, production, vision, task, movement (exports setGoal/clearGoal), separation, combat, reap (returns bool), explosion`, plus `targeting.ts` helpers (`isEnemy/findById/baseFootprintContains/enemyRobots/enemyBases/knownEnemyRobots/knownEnemyBases/nearest`).
